...
| Genesis G3 | `oli1`: oli-core compiler in `machine x64` (asm); steps 0–5: locals, expressions, strings, control flow, syscall values, procedures | **in progress; steps 0–5 green (`genesis/test.sh` layer 3); next: views, zones, layouts** |
